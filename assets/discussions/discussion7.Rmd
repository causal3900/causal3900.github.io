...
Follow the steps on the course website to download the data!
...
We will use logistic regression to fit a propnesity score
...
## Extension 3: Logistic regression
