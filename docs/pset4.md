...
<img src="pset4_files/figure-html/unnamed-chunk-7-1.png" width="672" />

``` r
hist(lalonde$re74)
```

<img src="pset4_files/figure-html/unnamed-chunk-7-2.png" width="672" />
...
#  mutate(age_dif= ...,
#         re74_dif = ...)
# L <- as.matrix(lalonde_sub_0[,c("age_dif","re74_dif")]) # the matrix of differences
