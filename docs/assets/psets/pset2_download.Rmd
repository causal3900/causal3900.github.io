...
Relevant material will be covered by **Sep 11**. Problem set is due **Sep 18**. Omit your name so we can have anonymous peer feedback. Compile to a PDF and submit the PDF on Canvas.
...
### 2.6. (5 points) Treatment effect heterogeneity {-}
